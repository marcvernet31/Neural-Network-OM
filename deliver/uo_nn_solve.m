...
function [Xtr,ytr,wo,fo,tr_acc,Xte,yte,te_acc,niter,tex] = uo_nn_solve(num_target, tr_freq,tr_seed,tr_p,te_seed,te_q,la,epsG,kmax,ils,ialmax,kmaxBLS,epsal,c1,c2,isd,sg_ga1,sg_al0,sg_ga2,icg,irc,nu,iheader)
    ...
    elseif(isd == 3)
        [wk,niter]=uo_BFGS(w,L,gL,epsG,kmax,epsal,kmaxBLS,ialmax,c1,c2);
    elseif(isd == 7)
        [wk, niter] = uo_SGM(w, Xtr, ytr, sg_ga1, sg_al0, sg_ga2, kmax, la);
    end
